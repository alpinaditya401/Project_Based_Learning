...
- [Laporan dan matriks requirement](REVIEW_REPORT.md): evidence dan batasan.
- [Checkpoint](CHECKPOINT.md): state terakhir dan tindak lanjut.
...
Semua kontrol perangkat saat ini SIMULASI. Bukti ESP32 fisik, kalibrasi, HTTPS deployment, uptime, dan retensi enam bulan nyata belum tersedia. Dokumen submission lama dipertahankan sebagai arsip, bukan bukti siap produksi.
